...
class Ui_LogIn(object):
    def setupUi(self, Form):
        ...
        self.label_2.setGeometry(QtCore.QRect(30, 20, 300, 420))
        ...
        self.label_3.setGeometry(QtCore.QRect(40, 60, 280, 381))
        self.label_3.setStyleSheet("background-color:rgba(0, 0, 0, 100);\n"
                                   "border-radius:15px;")
        self.label_3.setText("")
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(parent=self.widget)
        self.label_4.setGeometry(QtCore.QRect(90, 95, 170, 40))
        font = QtGui.QFont()
        ...
        self.lineEditUserName.setGeometry(QtCore.QRect(80, 165, 200, 31))
        self.lineEditUserName.setPlaceholderText("Nombre de Usuario")  # Establecer el texto predeterminado
        self.lineEditUserName.editingFinished.connect(lambda: self.check_empty(self.lineEditUserName))
        font = QtGui.QFont()
        ...
        self.lineEditPassword.setGeometry(QtCore.QRect(80, 230, 200, 31))
        self.lineEditPassword.setPlaceholderText("Password")  # Establecer el texto predeterminado
        self.lineEditPassword.setEchoMode(
            QtWidgets.QLineEdit.EchoMode.Password)  # Establecer el modo de eco para contraseñas
        self.lineEditPassword.editingFinished.connect(lambda: self.check_empty(self.lineEditPassword))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.pushButtonIngresar.setGeometry(QtCore.QRect(80, 300, 191, 40))
        font = QtGui.QFont()
        ...
        self.label_5.setGeometry(QtCore.QRect(60, 360, 241, 20))
        ...
        self.pushButtonCloseLogIn.setGeometry(QtCore.QRect(280, 30, 26, 24))
        font = QtGui.QFont()
        ...
        self.pushButtonMinimizeLogIn.setGeometry(QtCore.QRect(250, 30, 26, 24))
        font = QtGui.QFont()
        font.setFamily("Source Sans Pro Black")
    ...
    def check_empty(self, widget):
        try:
            if widget.text() == "":  # Verificar si el texto está vacío
                widget.setPlaceholderText(widget.placeholderText())  # Establecer el texto predeterminado
        except Exception as ex:
            print("Error en check_empty:", ex)

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "Form"))
        self.label_4.setText(_translate("Form", "Iniciar Sesión"))
        self.lineEditUserName.setText(_translate("Form", ""))
        self.lineEditPassword.setText(_translate("Form", ""))
